...
use veryl_parser::text_table::{self, TextId};
...
token_with_comments!(BBool);
token_with_comments!(LBool);
...
token_with_comments!(P8);
token_with_comments!(P16);
token_with_comments!(P32);
token_with_comments!(P64);
