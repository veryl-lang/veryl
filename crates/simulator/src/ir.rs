...
pub use declaration::{Clock, Module, Reset};
pub use event::Event;
pub use expression::{Expression, ExpressionContext};
pub use proto::{
    ConvAssignStatement, ConvDeclaration, ConvExpression, ConvIfStatement, ConvStatement,
    ProtoAssignStatement, ProtoExpression, ProtoIfStatement, ProtoOperand, ProtoStatement,
};
pub use statement::{AssignStatement, IfStatement, Statement};
...
pub struct Ir {
    ...
    pub ff_values: Vec<Box<[FfValue]>>,
    pub comb_values: Vec<Box<[CombValue]>>,
