...
use crate::ir::{
    Component, Comptime, Declaration, FfClock, FfReset, FuncArg, FuncPath, FuncProto, Function,
    Interface, IrResult, Signature, Type, ValueVariant, VarId, VarIndex, VarKind, VarPath,
    VarSelect, Variable,
};
...
pub struct Context {
    ...
    overrides: Vec<HashMap<VarPath, ValueVariant>>,
...
impl Context {
    ...
    pub fn push_override(&mut self, x: HashMap<VarPath, ValueVariant>) {
