...
mod tests {
    ...
    fn signed_unsigned() {
        ...
        let x01 = Value::from_str("8'hf2").unwrap();
        let x10 = op.eval_value_binary(&x00, &x01, Some(16), false, &mut cache);
        let x11 = op.eval_value_binary(
            &op.eval_value_binary(&x00, &x00, Some(16), false, &mut cache),
            &x01,
            Some(16),
            false,
            &mut cache,
    ...
    fn unary_add() {
        ...
        let x06 = Value::from_str("8'shx7").unwrap();
        let x07 = Value::from_str("8'shz8").unwrap();
        let x00 = op.eval_value_unary(&x00, Some(16), false, &mut cache);
        let x01 = op.eval_value_unary(&x01, Some(16), false, &mut cache);
        let x02 = op.eval_value_unary(&x02, Some(16), false, &mut cache);
        let x03 = op.eval_value_unary(&x03, Some(16), false, &mut cache);
        let x04 = op.eval_value_unary(&x04, Some(16), true, &mut cache);
        let x05 = op.eval_value_unary(&x05, Some(16), true, &mut cache);
        let x06 = op.eval_value_unary(&x06, Some(16), true, &mut cache);
        let x07 = op.eval_value_unary(&x07, Some(16), true, &mut cache);
        ...
        let x06 = Value::from_str("8'shx7").unwrap();
        let x07 = Value::from_str("8'shz8").unwrap();
        let x00 = op.eval_value_unary(&x00, Some(68), false, &mut cache);
        let x01 = op.eval_value_unary(&x01, Some(68), false, &mut cache);
        let x02 = op.eval_value_unary(&x02, Some(68), false, &mut cache);
        let x03 = op.eval_value_unary(&x03, Some(68), false, &mut cache);
        let x04 = op.eval_value_unary(&x04, Some(68), true, &mut cache);
        let x05 = op.eval_value_unary(&x05, Some(68), true, &mut cache);
        let x06 = op.eval_value_unary(&x06, Some(68), true, &mut cache);
        let x07 = op.eval_value_unary(&x07, Some(68), true, &mut cache);
    ...
    fn unary_bit_and() {
        ...
        let x02 = op.eval_value_unary(&x02, Some(16), false, &mut cache);
        let x03 = op.eval_value_unary(&x03, Some(16), false, &mut cache);
        let x04 = op.eval_value_unary(&x04, Some(16), false, &mut cache);
        let x05 = op.eval_value_unary(&x05, Some(16), false, &mut cache);
        let x06 = op.eval_value_unary(&x06, Some(16), false, &mut cache);
        let x07 = op.eval_value_unary(&x07, Some(16), false, &mut cache);
        ...
        let x02 = op.eval_value_unary(&x02, Some(68), false, &mut cache);
        let x03 = op.eval_value_unary(&x03, Some(68), false, &mut cache);
        let x04 = op.eval_value_unary(&x04, Some(68), false, &mut cache);
        let x05 = op.eval_value_unary(&x05, Some(68), false, &mut cache);
        let x06 = op.eval_value_unary(&x06, Some(68), false, &mut cache);
        let x07 = op.eval_value_unary(&x07, Some(68), false, &mut cache);
    ...
    fn binary_add() {
        ...
        let x00 = op.eval_value_binary(&x00, &x10, Some(16), false, &mut cache);
        let x01 = op.eval_value_binary(&x01, &x11, Some(16), false, &mut cache);
        let x02 = op.eval_value_binary(&x02, &x12, Some(16), false, &mut cache);
        let x03 = op.eval_value_binary(&x03, &x13, Some(16), false, &mut cache);
        let x04 = op.eval_value_binary(&x04, &x14, Some(16), true, &mut cache);
        let x05 = op.eval_value_binary(&x05, &x15, Some(16), true, &mut cache);
        let x06 = op.eval_value_binary(&x06, &x16, Some(16), true, &mut cache);
        let x07 = op.eval_value_binary(&x07, &x17, Some(16), true, &mut cache);
        ...
        let x16 = Value::from_str("8'shx3").unwrap();
        let x17 = Value::from_str("8'shz4").unwrap();
        let x00 = op.eval_value_binary(&x00, &x10, Some(68), false, &mut cache);
        let x01 = op.eval_value_binary(&x01, &x11, Some(68), false, &mut cache);
        let x02 = op.eval_value_binary(&x02, &x12, Some(68), false, &mut cache);
        let x03 = op.eval_value_binary(&x03, &x13, Some(68), false, &mut cache);
        let x04 = op.eval_value_binary(&x04, &x14, Some(68), true, &mut cache);
        let x05 = op.eval_value_binary(&x05, &x15, Some(68), true, &mut cache);
        let x06 = op.eval_value_binary(&x06, &x16, Some(68), true, &mut cache);
        let x07 = op.eval_value_binary(&x07, &x17, Some(68), true, &mut cache);
    ...
    fn binary_bit_and() {
        ...
        let x02 = op.eval_value_binary(&x02, &x12, Some(16), false, &mut cache);
        let x03 = op.eval_value_binary(&x03, &x13, Some(16), false, &mut cache);
        let x04 = op.eval_value_binary(&x04, &x14, Some(16), false, &mut cache);
        let x05 = op.eval_value_binary(&x05, &x15, Some(16), false, &mut cache);
        let x06 = op.eval_value_binary(&x06, &x16, Some(16), false, &mut cache);
        let x07 = op.eval_value_binary(&x07, &x17, Some(16), false, &mut cache);
        ...
        let x02 = op.eval_value_binary(&x02, &x12, Some(68), false, &mut cache);
        let x03 = op.eval_value_binary(&x03, &x13, Some(68), false, &mut cache);
        let x04 = op.eval_value_binary(&x04, &x14, Some(68), false, &mut cache);
        let x05 = op.eval_value_binary(&x05, &x15, Some(68), false, &mut cache);
        let x06 = op.eval_value_binary(&x06, &x16, Some(68), false, &mut cache);
        let x07 = op.eval_value_binary(&x07, &x17, Some(68), false, &mut cache);
