...
fn system_function() {
    ...
    let exp = r#"module ModuleA {
  let var0(a): logic = 'hx;
  const var1(b0): bit<32> = 'h00000000;
  const var2(b1): bit<32> = 'h00000000;
  const var3(b2): bit<32> = 'h00000001;
  const var4(b3): bit<32> = 'h00000002;
  const var5(b4): bit<32> = 'h00000002;
  const var6(b5): bit<32> = 'h00000003;
...
fn generic_function() {
    ...
    let exp = r#"module ModuleA {
  let var0(a): logic<10> = 'hxxx;
  var var1(b): logic<10> = 'hxxx;
  var var3(FuncA.return): logic<10> = 'hxxx;
  input var4(FuncA.x): logic<10> = 'hxxx;
  func var2(FuncA) -> var3 {
    var3 = (var4 + 00000001);
  }
