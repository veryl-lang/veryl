...
pub struct AssignTable {
    ...
    pub maybe_assigned: Vec<VarPath>,
}
...
impl AssignTable {
    ...
    pub fn merge_by_or(
        ...
        self.maybe_assigned.append(&mut value.maybe_assigned);
    }
    ...
    pub fn maybe_assigned(&self, path: &VarPath) -> bool {
        for x in &self.maybe_assigned {
