module veryl_testcase_Module83;
    ...
    // arrays of p* types
    byte unsigned     _p [2]; always_comb _p = '{1, 255};
    shortint unsigned _q [3]; always_comb _q = '{1, 100, 65535};
    int unsigned      _r [2]; always_comb _r = '{1, 4294967295};
