module veryl_testcase_Module02;
    ...
    // signed integer
    byte     _b   ; always_comb _b    = 1;
    shortint _bb  ; always_comb _bb   = 1;
    int      _bbb ; always_comb _bbb  = 1;
    longint  _bbbb; always_comb _bbbb = 1;
    ...
    byte              _ggggg      [2]; always_comb _ggggg      = '{1, 1};
    shortint          _gggggg     [2]; always_comb _gggggg     = '{1, 1};
    int               _ggggggg    [2]; always_comb _ggggggg    = '{1, 1};
    longint           _gggggggg   [2]; always_comb _gggggggg   = '{1, 1};
