module veryl_testcase_Module68H
    import veryl_testcase_Package68G::WIDTH;
    import __std___lzc_pkg__veryl_testcase_Package68G_WIDTH::lzc_result,
        __std___lzc_pkg__veryl_testcase_Package68G_WIDTH::lzc;
(
